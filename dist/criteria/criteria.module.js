...
const criteria_resolver_1 = require("./criteria.resolver");
...
exports.CriteriaModule = CriteriaModule = __decorate([
    (0, common_1.Module)({
        imports: [
            ...
            typeorm_1.TypeOrmModule.forFeature([criteria_entity_1.Criteria, users_entity_1.Users]),
        ],
        providers: [criteria_service_1.CriteriaService, criteria_resolver_1.CriteriaResolver],
